import type { Category, RawItem, EnrichedItem } from "../types";
...
const buildTags = (item: RawItem): string[] => {
...
export const descriptionById: Record<string, string> = {
...
export const items: EnrichedItem[] = enrichItems(rawItems, descriptionById);
