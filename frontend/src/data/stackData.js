...
export const descriptionById = {
  ...
  'aws-msk':
    'Managed Apache Kafka service; used for event streaming and real-time data pipelines.',
  'aws-transit-gateway':
  ...
  'git':
    'Distributed version control system; used for source code management and collaboration.',
  'argocd':
  ...
  'keycloak':
    'Open-source identity and access management; used for SSO, OIDC, and SAML federation.',
  'istio':
  ...
  'snyk':
    'Developer security platform; used for vulnerability scanning in code, dependencies, containers, and IaC.',
  'harbor':
  ...
  'jaeger':
    'Open-source distributed tracing system; used for monitoring microservice request flows.',
  'apache-nifi':
  ...
  'mattermost':
    'Open-source team messaging platform; used for secure, self-hosted collaboration.',
  'platform-one':
  ...
  'sbom':
    'Machine-readable inventory of software components and dependencies in standardized formats (SPDX, CycloneDX).',
  'nist-800-53':
  ...
  'lula':
    'Compliance-as-code tool for managing security controls through git workflows with OSCAL-native outputs.',
  'azure-government':
  ...
  'jwcc':
    'DoD multi-cloud acquisition vehicle providing enterprise cloud from AWS, Azure, Google, and Oracle at all classification levels.',
  ...
  // ──────────────────────────────────────────────
  'gcp':
    'Google public cloud platform offering compute, storage, networking, data analytics, and AI services.',
  ...
  'gcp-vpc':
    'Global virtual network with subnets, firewall rules, and private service access.',
  'gcp-firewall-rules':
  ...
  'gcp-cloud-dns':
    'Managed DNS service with 100% SLA, DNSSEC support, and private DNS zones.',
  'gcp-filestore':
    'Managed NFS file storage for applications requiring a file system interface.',
...
export const rawItems = [
  ...
  },
  {
    ...
    type: 'Platform',
    synonyms: ['JWCC'],
    commonWith: ['aws-govcloud', 'azure-government', 'google-cloud-government', 'oracle-cloud-government'],
