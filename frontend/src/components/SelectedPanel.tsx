...
interface CopyMenuProps {
  onCopyAs: (format: ExportFormat) => void;
}

function CopyMenu({ onCopyAs }: Readonly<CopyMenuProps>): React.JSX.Element {
  return (
...
function SelectedGroups({
  ...
  inheritedSet,
  removeItem,
}: Readonly<SelectedGroupsProps>): React.JSX.Element {
  return (
...
function ProjectContext({
  sandbox,
  hasActualChanges,
}: Readonly<ProjectContextProps>): React.JSX.Element | null {
...
interface Props {
  ...
  selectedByCategory: { category: Category; items: EnrichedItem[] }[];
  inheritedSet: Set<string>;
  handleCopyAs: (format: ExportFormat) => void;
  hasActualChanges: boolean;
}
