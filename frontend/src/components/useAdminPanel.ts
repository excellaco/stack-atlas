...
interface ProjectActionsReturn {
  ...
  handleCreateProject: (e: React.SubmitEvent<HTMLFormElement>) => Promise<void>;
  handleCreateSub: (e: React.SubmitEvent<HTMLFormElement>) => Promise<void>;
}
...
function useProjectActions(
  ...
  const handleCreateProject = async (e: React.SubmitEvent<HTMLFormElement>): Promise<void> => {
    e.preventDefault();
  ...
  const handleCreateSub = async (e: React.SubmitEvent<HTMLFormElement>): Promise<void> => {
    e.preventDefault();
